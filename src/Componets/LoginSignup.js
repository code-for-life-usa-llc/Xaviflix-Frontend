    ...
    <div className="user-box">
        ...
        onSubmit={
          (event) =>  {
            ...
            this.props.userLogin({"username": this.state.loginUsername, "password": this.state.loginPassword})
          }
        }
        >
          ...
          <form
            ...
            onSubmit={
              (event) =>  {
                event.preventDefault();
                this.props.userSignup({"username": this.state.signupUsername, "name": this.state.signupName, "password": this.state.signupPassword})
              }
            }
            >
